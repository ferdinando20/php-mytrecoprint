        ...
        <div class="container">
            <div class="row d-flex justify-content-center text-secondary">
                <div class="col-8 col-md-6 col-lg-4 border px-5 py-5 bg-white">
                    <form class="mb-3 mt-md-4" action="<?php echo site_url('adminpanel/register'); ?>" method="post">
                        ...
                        <div class="d-grid">
                            <button class="btn btn-outline-dark btn-block" type="submit">Sign Up</button>
                        </div>
                    </form>
                    <div>
                        <p class="mb-0 mt-md-4">Already have an account? <a href="<?php echo site_url('adminpanel/login'); ?>" class="text-primary fw-bold">Sign
                                In</a></p>
                    </div>
                </div>
            </div>
